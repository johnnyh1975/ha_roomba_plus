...
[![Version](https://img.shields.io/badge/Version-4.2.7-brightgreen.svg)](https://github.com/johnnyh1975/ha_roomba_plus/releases)
...
|---|---|---|
| **Any supported robot** | **v4.2.7** (stable) — the default in HACS | One line for both generations. No beta channel needed. |
| **Roomba Max · Combo/Plus 400-series** and other newer cloud robots | **v4.2.7** | Earlier stable lines **cannot connect to your robot at all** |
| Still on the 4.1 line | **v4.2.7** | Everything fixed in 4.1.1 through 4.1.8 is in it. That line has ended |
