...
[![Version](https://img.shields.io/badge/Version-4.1.5-brightgreen.svg)](https://github.com/johnnyh1975/ha_roomba_plus/releases)
...
|---|---|---|
| **Any supported robot** | **v4.1.5** (stable) — the default in HACS | One line for both generations. No beta channel needed any more. |
| **Roomba Max · Combo/Plus 400-series** and other newer cloud robots | **v4.1.5** | Earlier stable lines **cannot connect to your robot at all** |
